...
- This project benefits users keep an organized and timely plan for their day. Users can input information into the scheduler by the hour and allows them to save the information in the local server.
